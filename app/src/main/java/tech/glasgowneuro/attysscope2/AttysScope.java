...
public class AttysScope extends AppCompatActivity { // main activity
    ...
    public class Ch2Converter {
        ...
        private final String[] units = {"V", "V"};
...
//                                tmpSample[nRealChN++] = sample[AttysComm.INDEX_Analogue_channel_1] * 2000;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gain[AttysComm.INDEX_Analogue_channel_1] = 500.0f;

        gain[AttysComm.INDEX_Analogue_channel_2] = 500.0f;
        Toast.makeText(getApplicationContext(),
                String.format(Locale.getDefault(), "Channel 1 & 2 gain set to x%d", (int) gain[AttysComm.INDEX_Analogue_channel_1]), Toast.LENGTH_LONG).show();
        ...
        realtimePlotView.setMaxChannels(15); // united states
